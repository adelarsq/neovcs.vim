...
M.VcsBlameLineGit = function()
    local r = table.concat(
        vim.fn.systemlist("git -C " ..
            ...
            " blame -L " .. vim.fn.line(".") .. "," .. vim.fn.line(".") .. " " .. vim.fn.expand("%:t")), "\n")
    M.ShowMessage(r)
end
...
function M.setup()
    ...
    vim.keymap.set("n", "<leader>vo", function() M.VcsOpenLineUrl() end,
        { silent = true, desc = "Open current line URL" })

    -- Open repository URL
    vim.keymap.set("n", "<leader>vO", function() M.VcsOpenUrl() end, { silent = true, desc = "Open repository URL" })

    -- Reload changes from remote
    vim.keymap.set("n", "<leader>vr", function() M.VcsReload() end,
        { silent = true, desc = "Reload changes from remote" })

    -- Show status
    vim.keymap.set("n", "<leader>vs", function() M.VcsStatus() end, { silent = true, desc = "Show VCS status" })

    -- Pull changes from remote
    vim.keymap.set("n", "<leader>vp", function() M.VcsUpdateReceive() end,
        { silent = true, desc = "Pull changes from remote" })

    -- Push changes to remote
    vim.keymap.set("n", "<leader>vP", function() M.VcsUpdateSend() end,
        { silent = true, desc = "Push changes to remote" })
