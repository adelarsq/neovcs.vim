...
function M.setup()
    vim.api.nvim_set_keymap('n', '<leader>vh', ':lua VcsHelp()<CR>', { desc = 'Neovcs help'})
    vim.api.nvim_set_keymap('n', '<leader>va', ':lua VcsAddFile("")<left><left>', { desc = 'Add file'})
    vim.api.nvim_set_keymap('n', '<leader>vA', ':lua VcsAddFiles("","")<left><left><left><left><left>', { desc = 'Add all files'})
    vim.api.nvim_set_keymap('n', '<leader>vb', ':lua VcsBlameLine()<CR>', { desc = 'Blame line'})
    vim.api.nvim_set_keymap('n', '<leader>vB', ':lua VcsBlameFile()<CR>', { desc = 'Blame file'})
    vim.api.nvim_set_keymap('n', '<leader>vc', ':lua VcsCommit("","")<left><left><left><left><left>', { desc = 'Commit'})
    vim.api.nvim_set_keymap('n', '<leader>vC', ':lua VcsAmend("")<left><left><left>', { desc = 'Amend'})
    vim.api.nvim_set_keymap('n', '<leader>vd', ':lua VcsHunkDiff()<CR>', { desc = 'Hunk diff'})
    vim.api.nvim_set_keymap('n', '<leader>vD', ':lua VcsDiff("")<left><left>', { desc = 'Diff'})
    vim.api.nvim_set_keymap('n', '<leader>vl', ':lua VcsLogFile()<CR>', { desc = 'Log file'})
    vim.api.nvim_set_keymap('n', '<leader>vL', ':lua VcsLogProject()<CR>', { desc = 'Log project'})
    -- vim.api.nvim_set_keymap('n', '<leader>vg', ':lua VcsLogFileGraph()<CR>', { desc = ''})
    -- vim.api.nvim_set_keymap('n', '<leader>vG', ':lua VcsLogProjectGraph()<CR>', { desc = ''})
    vim.api.nvim_set_keymap('n', '<leader>vm', ':lua VcsResolve()<CR>', { desc = 'Resolve (svn)'})
    vim.api.nvim_set_keymap('n', '<leader>vn', ':lua VcsNextHunk()<CR>', { desc = 'Next hunk'})
    vim.api.nvim_set_keymap('n', '<leader>vN', ':lua VcsPrevHunk()<CR>', { desc = 'Prev hunk'})
    vim.api.nvim_set_keymap('n', '<leader>vo', ':lua VcsOpenLineUrl()<CR>', { desc = 'Open URL on current line'})
    vim.api.nvim_set_keymap('n', '<leader>vO', ':lua VcsOpenUrl()<CR>', { desc = 'Open URL'})
    vim.api.nvim_set_keymap('n', '<leader>vr', ':lua VcsReload()<CR>', { desc = 'Pull and Push'})
    vim.api.nvim_set_keymap('n', '<leader>vs', ':lua VcsStatus()<CR>', { desc = 'Status'})
    vim.api.nvim_set_keymap('n', '<leader>vp', ':lua VcsUpdateReceive()<CR>', { desc = 'Pull'})
    vim.api.nvim_set_keymap('n', '<leader>vP', ':lua VcsUpdateSend()<CR>', { desc = 'Push'})
    vim.api.nvim_set_keymap('n', '<leader>vt', ':lua VcsShowBranchs()<CR>', { desc = 'Branchs'})
    vim.api.nvim_set_keymap('n', '<leader>vu', ':lua VcsHunkUndo()<CR>', { desc = 'Undo hunk'})
    vim.api.nvim_set_keymap('n', '<leader>vU', ':lua VcsUndoLastCommit()<CR>', { desc = 'Undo last commit'})
    vim.api.nvim_set_keymap('n', '<leader>vx', ':lua VcsRmFile("")<left><left>', { desc = 'Remove file'})
    vim.api.nvim_set_keymap('n', '<leader>vX', ':lua VcsRevertLastCommit()<CR>', { desc = 'Revert last commit'})
